...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        ...
        try {
            setLoading(true);
            const res = await axios.post('http://localhost:5050/api/v1/user/profile/edit', formData,{
                headers:{
...
const EditProfile = () => {
    ...
    // ✅ File select handler with size check
    const fileChangeHandler = (e) => {
        const file = e.target.files?.[0];
        if (file) {
            if (file.size > 10 * 1024 * 1024) { // 10 MB limit
                toast.error("File too big! Max 10 MB allowed.");
                return;
            }
    ...
    const editProfileHandler = async () => {
        ...
        try {
            ...
            const res = await axios.post(
                'https://insta-2-d9wn.onrender.com/api/v1/user/profile/edit',
                formData,
                {
